...
<task type="auto">
  ...
  <verify>
    ...
    - See empty state or list of workspaces
    - Fill form and submit to create workspace
    - Redirected to /w/[new-workspace-id]/settings
    - New workspace appears in data/workspaces/ as .db file
    - New workspace added to workspaces.json registry
  </verify>
  <done>
...
<task type="auto">
  ...
  <verify>
    ...
    - Fill business details, save, values persist
    - Set founded year, save, value persists
  </verify>
  <done>
...
<task type="auto">
  ...
  <verify>
    ...
    - Click it, taken to correct workspace
    - Switch to other workspace via dropdown
    - Reload page, dropdown shows correct current workspace
  </verify>
  <done>
