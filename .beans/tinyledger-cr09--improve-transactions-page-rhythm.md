...
Consider:
- Increasing gap before the timeline section to visually separate controls from content
- Reducing gap between the summary header and filter bar (they're related controls)
- Slightly varying section widths or padding to create rhythm
