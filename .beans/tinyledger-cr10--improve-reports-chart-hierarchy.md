...
Consider:
- Making the Net Income chart (primary insight) wider or more prominent
- Using a 2-column grid for the secondary charts (Income vs Expense + Spending Breakdown)
- Strengthening the "Financial Overview" section header as a visual break between summary cards and charts
