	...
	<header class="flex flex-wrap items-center justify-between gap-4">
		...
		<div class="flex items-center gap-2">
			...
			<a
				...
				class="inline-flex items-center gap-1.5 rounded-md border border-input-border bg-input px-3 py-2 text-sm font-medium text-fg shadow-sm hover:bg-surface focus:outline-none focus:ring-2 focus:ring-primary/50"
			>
